<script lang="ts">
  ...
  let fieldErrors = $derived(
    submitted && !validationResult.success
...
<form class="mt-8 w-full max-w-md space-y-6" onsubmit={handleSubmit} novalidate>
  <h1>
    <img src={logo} alt="Taskify Logo" class="h-12 w-auto" />
  </h1>

  <div class="space-y-1 pb-4">
    <h2 class="text-3xl font-bold text-primary-500">Create your account</h2>
    <p class="text-sm text-surface-600 dark:text-surface-400">
      Join Taskify today and start managing your tasks efficiently.
    </p>
  </div>
  ...
  <div class="space-y-4">
    ...
    <div class="space-y-3">
      ...
      <div class="flex flex-col gap-4">
        <label
          class="relative flex cursor-pointer rounded-xl border p-4 transition-all {role ===
          'employee'
        ...
        >
          ...
          <div class="flex w-full items-center gap-4">
            <div
              class="flex h-12 w-12 shrink-0 items-center justify-center rounded-lg transition-colors {role ===
              'employee'
            ...
            <div class="flex-1">
              ...
              >
                Regular access to tasks and projects.
              </div>
            </div>
            <div
              class="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border-2 transition-colors {role ===
              'employee'
  ...
  <div>
    <button
      ...
      class="group relative flex w-full justify-center rounded-xl border border-transparent bg-primary-500 px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-primary-600 focus:ring-2 focus:ring-primary-500/50 focus:outline-none active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
    >
  ...
  <div
    class="flex items-center justify-center gap-1 text-sm text-surface-600 dark:text-surface-400"
  >
